...
### P1. Recursive Consistency Checks
...
### P2. Logical Chaining with Transitions
...
### P13. Figure/Table Definition Order
...
### P23. Goal-Problem-Solution Rhythm
...
### P24. The Nugget — One Key Insight Per Paper
...
### P7. Avoid Exhaustive-Sounding Enumerations
...
### P8. Avoid Negation-Contrast Structures
...
### P11. Avoid Colloquial Terminology in Titles/Formal Claims
...
### P12. Match Discussion Tone to Thesis Voice
...
### P17. Calibrated Confidence Language
...
### P28. AI-Writing Tell Detection
Actively scan for and eliminate patterns that mark text as AI-generated. Common tells: (1) "not X, but Y" negation-contrast (see P8), (2) "delve", "leverage", "landscape", "tapestry", "multifaceted", "paradigm shift", (3) sentences starting with "Moreover", "Furthermore", "Additionally" in sequence, (4) formulaic transitions ("Building on this", "Taking this a step further"), (5) hollow intensifiers ("crucial", "vital", "essential" used interchangeably), (6) mirroring the user's exact phrasing back, (7) overly balanced "on one hand / on the other hand" structures. Replace with direct, specific language.
...
### P3. Math for Clarity, Not Complexity
...
### P25. Triple Explanation — Text, Equation, Figure
...
### P27. Equation-Code Correspondence
...
### P6. Figure-Text-Caption Consistency
...
### P18. Interpret Figures, Don't Just Reference
...
### P30. Figure Caption Self-Sufficiency
...
### P9. Cite All Named Models/Benchmarks/Datasets
...
### P21. Citation Completeness at First Mention
...
### P19. Strategic Limitation Placement
